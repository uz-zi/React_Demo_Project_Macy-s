...
//         // Open the clicked section and close all others
...
//         // If the filter is "Color", update selectedColors as well
//         if (filterName === "Color") {
...
//     // Handler to clear all selected options
...
//                   {filter.name}
//                 </button>
//                 {/* Display selected options below the filter name */}
